...
**Scope:** building the one remote MCP endpoint every AI host connects to — tool/result contracts, legacy and stateless transport, auth, OAuth and grant administration.
...
| Adding stateless MCP `2026-07-28` beside legacy clients | [`../shared/modern-protocol.md`](../shared/modern-protocol.md) |
...
| Debugging something broken | [`../shared/pitfalls.md`](../shared/pitfalls.md) (20 real ones) |
...
| New stateless clients plus existing hosts | keep Phase 1's dispatcher, add the dual-stack adapter in `shared/modern-protocol.md`; do not fork business handlers |
...
- MCP specs: [initialize-based 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25) · [stateless 2026-07-28 release](https://blog.modelcontextprotocol.io/posts/2026-07-28/) · [authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization)
